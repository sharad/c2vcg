...
# serial 2 C2VCG_VAR_SYS_ERRLIST

dnl @start 1
AC_DEFUN([C2VCG_VAR_SYS_ERRLIST],
[AC_CACHE_CHECK([for sys_errlist],
c2vcg_cv_var_sys_errlist,
[AC_TRY_LINK([int *p;], [extern int sys_errlist; p = &sys_errlist;],
	    c2vcg_cv_var_sys_errlist=yes, c2vcg_cv_var_sys_errlist=no)])
if test x"$c2vcg_cv_var_sys_errlist" = xyes; then
