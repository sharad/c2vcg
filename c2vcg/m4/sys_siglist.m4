...
# serial 2 C2VCG_VAR_SYS_SIGLIST

AC_DEFUN([C2VCG_VAR_SYS_SIGLIST],
[AC_CACHE_CHECK([for sys_siglist],
c2vcg_cv_var_sys_siglist,
[AC_TRY_LINK([int *p;], [extern int sys_siglist; p = &sys_siglist;],
	    c2vcg_cv_var_sys_siglist=yes, c2vcg_cv_var_sys_siglist=no)])
if test x"$c2vcg_cv_var_sys_siglist" = xyes; then
