/* @(#)id-emit.c -- Briefly describe here 
...
static struct id_sym *hashtab[HASH_SIZE];
...
sym_lookup (char *name)
{
  ...
  //  s = (struct id_sym *) xmalloc (sizeof (struct id_sym));
  s = (struct id_sym *) malloc (sizeof (struct id_sym));
